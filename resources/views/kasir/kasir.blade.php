...
<body>
                ...
                <div class="w-140 h-115 flex flex-col items-center bg-white">
                    ...
                    @foreach ($transactions as $trx)
                        <div class="flex flex-row items-center justify-around w-135 h-10 border-b">
                            <input type="radio" name="selected_id" value="{{ $trx->id }}" id="">
    ...
    function setLocation() {
     ...
     function setDelete() {
        ...
        form.action = `/transaction/${selected.value}`;  // pastikan route ke TransactionController@destroy
        form.method = 'POST';

        // Set method spoofing jadi DELETE
